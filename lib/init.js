 ...
 *   @engine/ai     — pickBestMove, pickWeightedMove, pickRandomMove (AI opponents)
 *   @engine/turns  — createTurnManager (multi-player turn management)
 *   @engine/cards  — createDeck, shuffleDeck, dealCards, evaluatePokerHand
 *   @engine/animate — createTween, updateTweens, easing functions
 *
